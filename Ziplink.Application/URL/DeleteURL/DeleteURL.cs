...
namespace Ziplink.Application.URL.DeleteURL;
public class DeleteURL : IDeleteURL
{
    private readonly IZiplinkRepository<EntityUrl> _repo;
    private readonly IMapper _mapper;
    private static readonly ILog _logger = LogManager.GetLogger(typeof(DeleteURL));

    public DeleteURL(IZiplinkRepository<EntityUrl> repo, IMapper mapper)
    {
        _repo = repo;
        _mapper = mapper;
    }
